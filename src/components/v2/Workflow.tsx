...
const Workflow = () => {
  const steps = [
    { title: "Face Registration", desc: "Secure cryptographic enrollment of facial biometric markers.", icon: Camera },
    { title: "AI Monitoring", desc: "Autonomous agents crawl surface and deep web 24/7.", icon: Search },
    { title: "Content Analysis", desc: "Neural networks classify content integrity in real-time.", icon: Cpu },
    { title: "Threat Detection", desc: "Immediate identification of deepfakes and morphs.", icon: ShieldCheck },
    { title: "Instant Alerts", desc: "Real-time notifications via secure enterprise channels.", icon: Bell },
  ];
      ...
      <div className="container mx-auto px-6">
        <div className="flex flex-col lg:flex-row gap-20 items-center">
          <div className="lg:w-1/2">
            <h2 className="text-5xl lg:text-7xl font-bold tracking-tighter text-white mb-12">How E-vara <br /> <span className="text-electric-blue italic">Protects</span> You</h2>
