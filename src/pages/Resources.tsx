...
const ResourcesPage = () => {
  useSEO({
    title: "Resources",
    description: "Cybersecurity resources, articles, and insights from E-VARA.",
  ...
  return (
    <div className="min-h-screen bg-[#050608] text-white selection:bg-primary/30 font-mono">
      ...
      <div className="container mx-auto px-6 py-24 text-center">
        <h1 className="text-6xl font-black tracking-tighter uppercase mb-6 italic">Resources</h1>
        <p className="text-muted-foreground font-body text-lg">
          Resource center is currently being compiled.
        </p>
      </div>
    </div>
  );
