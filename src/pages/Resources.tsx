    ...
    <div className="min-h-screen bg-[#050608] text-white selection:bg-primary/30 font-mono">
      ...
      <div className="container mx-auto px-6 py-24">
        <div className="text-center max-w-2xl mx-auto mb-20">
          <h1 className="text-5xl font-black tracking-tighter uppercase mb-6 italic">Intelligence Hub</h1>
          <p className="text-muted-foreground font-body text-lg">
            Research, technical specifications, and strategic guidance for modern security operations centers.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto mb-24">
          {resources.map((item, i) => (
            <div key={i} className="flex flex-col p-6 rounded-2xl border border-white/5 bg-[#0A0C12] hover:border-primary/30 transition-colors">
              ...
              <p className="text-sm text-muted-foreground font-body flex-grow mb-6">{item.desc}</p>
              <Button variant="outline" className="w-full border-white/10 hover:bg-white/5 uppercase tracking-widest text-[10px] font-bold">
