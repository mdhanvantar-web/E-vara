...
const ThreatDetectionPage = () => {
  useSEO({
    ...
    description: "Learn about E-VARA's autonomous threat detection capabilities.",
  ...
  return (
    <div className="min-h-screen bg-[#050608] text-white selection:bg-primary/30 font-mono">
      ...
      <div className="container mx-auto px-6 py-24 text-center">
        <h1 className="text-6xl font-black tracking-tighter uppercase mb-6 italic">Threat Detection</h1>
        <p className="text-muted-foreground font-body text-lg">
          Advanced threat detection specifications will be available shortly.
        </p>
      </div>
    </div>
  );
